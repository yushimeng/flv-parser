#ifndef PROTOCOL_AMF0_HPP
#define PROTOCOL_AMF0_HPP
#include <string>
#include <vector>
...
/*
 ...
 1. the bytes proxy: StreamBuf
 // when we got some bytes from file or network,
 // use StreamBuf proxy to read/write bytes
...
public:
     ...
     */
    virtual error_t read(StreamBuf* stream) = 0;
    /**
     * write AMF0 instance to stream.
     */
    virtual error_t write(StreamBuf* stream) = 0;
    /**
...
public:
     ...
     */
    static Amf0Any* object_eof();
    /**
     * create an AMF0 empty ecma-array instance
     */
    static Amf0EcmaArray* ecma_array();
    /**
     * create an AMF0 empty strict-array instance
     */
    static Amf0StrictArray* strict_array();
...
public:
     ...
     */
    static error_t discovery(StreamBuf* stream, Amf0Any** ppvalue);
};
...
public:
    ...
    virtual error_t read(StreamBuf* stream);
    virtual error_t write(StreamBuf* stream);
...
public:
     ...
     * @remark: max index is count().
     */
    virtual Amf0Any* value_at(int index);
    // property set/get.
public:
    /**
 ...
 */
extern error_t amf0_read_any(StreamBuf* stream, Amf0Any** ppvalue);
 ...
 */
extern error_t srs_amf0_read_string(StreamBuf* stream, std::string& value);
extern error_t srs_amf0_write_string(StreamBuf* stream, std::string value);
 ...
 */
extern error_t srs_amf0_read_boolean(StreamBuf* stream, bool& value);
extern error_t srs_amf0_write_boolean(StreamBuf* stream, bool value);
 ...
 */
extern error_t srs_amf0_read_number(StreamBuf* stream, double& value);
extern error_t srs_amf0_write_number(StreamBuf* stream, double value);
 ...
 */
extern error_t srs_amf0_read_null(StreamBuf* stream);
extern error_t srs_amf0_write_null(StreamBuf* stream);
 ...
 */
extern error_t srs_amf0_read_undefined(StreamBuf* stream);
extern error_t srs_amf0_write_undefined(StreamBuf* stream);
...
// {
     ...
     */
    extern error_t amf0_read_utf8(StreamBuf* stream, std::string& value);
    extern error_t amf0_write_utf8(StreamBuf* stream, std::string value);
    
    extern bool amf0_is_object_eof(StreamBuf* stream);
    extern error_t amf0_write_object_eof(StreamBuf* stream, Amf0ObjectEOF* value);
    
    extern error_t amf0_write_any(StreamBuf* stream, Amf0Any* value);
// };
